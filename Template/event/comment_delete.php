<div class="activity-comment-wrapper">
    ...
    <p class="activity-title activity-comment-title">
        <?= e('%s removed a comment on task %s', $this->text->e($author), $this->url->link(t('#%d', $task['id']), 'TaskViewController', 'show', array('task_id' => $task['id'], 'project_id' => $task['project_id']), false, 'task-comment-link', t('View Task'))) ?>
